...
def copy_and_customize_site4():
    ...
    try:
        ...
        # Target for inserting the print takeaway button in the carousel section
    ...
    <div class="ltai-carousel-controls" role="group" aria-label="Carousel navigation">"""
        ...
        if carousel_target in content:
            ...
            # Fallback: let's try with normalized line endings / spaces
            normalized_target = carousel_target.replace("\r\n", "\n").strip()
            normalized_content = content.replace("\r\n", "\n")
            if normalized_target in normalized_content:
                normalized_content = normalized_content.replace(normalized_target, button_markup.replace("\r\n", "\n"))
