...
def main():
    ...
    if args.type == "teaser":
        ...
        full_scrolls = [
            os.path.join(kiosk_dir, "images", "lets-talk-ai-media.png"),
            os.path.join(kiosk_dir, "images", "lets-talk-ai-education.png"),
            os.path.join(kiosk_dir, "images", "lets-talk-ai-bus-stop.png")
        ]
